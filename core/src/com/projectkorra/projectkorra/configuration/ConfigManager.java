...
public class ConfigManager {
	...
	public static void configCheck(final ConfigType type) {
		...
		if (type == ConfigType.PRESETS) {
			...
			config.addDefault("Chat.Branding.ChatPrefix.Main", "MasterPowers");
			config.addDefault("Chat.Branding.ChatPrefix.Hover", "Bending brought to you by MasterPowers - HYPE MC exclusive!\\nClick for more info.");
			config.addDefault("Chat.Branding.ChatPrefix.Click", "");
